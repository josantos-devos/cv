...
var vendorBundleSrc = '/payment/build/vendor.bundle.js?v=1.0.0.402';
var developerBundleSrc = '/payment/build/app.bundle.js?v=1.0.0.402';
var plansBundleSrc = '/payment/build/plans-1.0.0.402.bundle.js';
var appJsSrc = '/payment/scripts/app.js?v=1.0.0.402';
...
var mainCssSrc = '/payment/stylesheets/zty/main.css?v=1.0.0.402';
var resFileName = 'dev.json';
var portalJsFileName = 'dev.json';
var esShimSrc = 'scripts/es6/es6-shim.min.js';
var hkgrostekfont = 'styles/HKGrotesk/css/hkgrostekfont.css?v=1.0.0.402';
switch (hostParts[0]) {
    case 'reg-builder':
        env = 'reg-assets';
...
var ecomJsonPath = baseUrl.replace('@@env', env) + '/contents/' + blobFolder +
    'zety.com/' + resFileName + '?v=1.0.0.402';;
...
var localizedTextJsonPath = baseUrl.replace('@@env', env) + '/contents/' + blobFolder +
    'zety.com/localizedText.json?v=1.0.0.402';
...
function loadImageFiles() {
    prefetchFiles(baseUrl.replace('@@env', env) + '/images/zty/logo.svg');
    prefetchFiles(baseUrl.replace('@@env', env) + '/images/zty/loading.gif');
    ...
    prefetchFiles(baseUrl.replace('@@env', env) + '/images/wlb/breadcrum-check-two.png');
    prefetchFiles(baseUrl.replace('@@env', env) + '/images/wlb/lc-sell-sprite.jpg');
    prefetchFiles(baseUrl.replace('@@env', env) + '/images/wlb/lc-sell-sprite.jpg');
...
var commonLocalizedTextJsonPath = baseUrl.replace('@@env', env) + '/contents/' + blobFolder +
    'common/localizedText.json?v=1.0.0.402';
